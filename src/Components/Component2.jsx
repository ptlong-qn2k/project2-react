    ...
    return (
        <div className="w-[1122px] mx-auto  md:w-full ">
            <div className="w-[1112px] mx-auto mb-[65px] md:w-full md:mb-[35px]">
                <h3
                    className="w-[1000px] mb-[6px] text-5xl uppercase font-bold md:text-[35px] md:w-full md:mb-[29px] md:leading-[43.75px]">
            ...
            <div className="w-[1112px] mb-[148px] mx-auto md:w-full md:mb-[52px]">
                <div className="flex flex-row mb-8 md:w-full md:flex-col">
                    ...
                    <div className="w-[480px] md:w-[324px] cursor-pointer">
                ...
                <div className=" flex flex-row pt-8 mb-8 md:flex-col">
                    ...
                    <div className="list-inside w-[546px] text-xl flex flex-col justify-between md:w-full md:text-lg cursor-pointer">
